...
public class HTTPRequest {
	 ...
	 * @param userAPIKey - received from simpleintelligence.com.
	 * @param DLtitle    - received from simpleintelligence.com.
	 * @param data       - path to your file or input string depend on used API.
	 */
	public HTTPRequest(String userAPIKey, String DLtitle, String data){

		this.data = data;
		this.fullSimpleIntelURL = baseSimpleIntelURL + DLtitle + "/" + userAPIKey;
	}
